...
namespace Ejercicio14
{
    class GestorFicheros
    {
        ...
        public async Task LeerArchivo(string rutaFichero)
        {
                try
                {
                    ...
                    using (FileStream fileStream = new FileStream(rutaFichero, FileMode.Open, FileAccess.Read,FileShare.Read,8192,FileOptions.Asynchronous))
                    {
