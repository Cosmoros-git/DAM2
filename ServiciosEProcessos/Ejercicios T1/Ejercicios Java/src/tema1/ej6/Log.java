...
public class Log {
    ...
    final String fileNameWithLocation = "src/tema1/ej6/Files/saludos.txt";

    public Log(){
        try {
            printWriter = new PrintWriter(new FileWriter(fileNameWithLocation));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }

    /*Fix 1, adding synchronized, works fine now.
